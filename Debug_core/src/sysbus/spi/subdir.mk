...
C_SRCS += \
../src/sysbus/spi/SPI_MASTER.c \
../src/sysbus/spi/SPI_SLAVE.c 

OBJS += \
./src/sysbus/spi/SPI_MASTER.o \
./src/sysbus/spi/SPI_SLAVE.o 

C_DEPS += \
./src/sysbus/spi/SPI_MASTER.d \
./src/sysbus/spi/SPI_SLAVE.d 


# Each subdirectory must supply rules for building sources it contributes
src/sysbus/spi/%.o: ../src/sysbus/spi/%.c
	@echo 'Building file: $<'
